...
public class Einkaufsliste {
	...
	public void einkaufStornieren() {
		einkaufsliste.clear();
		System.out.println("Der Einkauf wurde storniert.");
	}
	...
	public void listeAusgeben() {
		...
		for (Produkt p : einkaufsliste) {
			System.out.println("Produktname: " + p.getName() + "; EAN: " + p.getEan() + " Preis: " + p.getPreis() + "; Gewicht: " + p.getGewicht() + "; Anzahl: " + p.getAnzahl() + "; Kategorie: " + p.getKategorie());
		}
