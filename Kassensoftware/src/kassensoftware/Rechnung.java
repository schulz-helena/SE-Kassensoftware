...
public class Rechnung {
	...
	public static Float gesamtSumme = 0f;
	...
	/**
	 * Das gegebene Geld des Kunden wird hier im sp�teren Programmablauf
	 * aktualisiert.
	 * 
	 * @param geldNeu wird aus der GUI �bergeben
	 */
	 ...
	 * Bezahlvorgang des Kunden. Die <code>einkaufliste</code> wird anschlie�end
	 * wieder zur�ckgesetzt und ein neuer Einkauf kann gestartet werden.
	 * 
	 * @param rech HashMap mit <code>produkt p</code> das gekauft werden soll und
	 *             der dazugeh�rigen <code>anzahl</code>
	 */
	 ...
	 * <code>produkt</code> der <code>einkaufsliste</code> hinzugef�gt wurde. Die
	 * <code>zwischensumme</code> wird auch ausgegeben.
	 * 
	 * @param rech <code>HashMap</code> mit <code>produkt p</code> die gekauft
	 *             werden sollen und der dazugeh�rigen <code>anzahl</code>
	 * @return String: Zwischenrechnung wird als String zur�ckgegeben
	 */
	 ...
	 * <code>ArrayList</code> in einen String �berf�hrt.
	 * 
	 ...
	 * <code>rechnungBody</code> und <code>rechnungEnd</code> wird zusammengef�gt.
	 * 
