...
import kassensoftware.EinkaufPanel;
import kassensoftware.Einkaufsliste;
import kassensoftware.Kategorie;
import kassensoftware.Produkt;
import kassensoftware.Rechnung;
...
public class EinkaufTest {
	...
	/**
	 * Testet, ob der Bestand verändert wird und ob dieser auch korrekt
	 * verändert wird.
	 */
	@Test
	public void bestandTest() {
		...
		// Stimmt der Bestand mit dem erwarteten Bestand ueberein?
	...
	/**
	 * Testet, ob der Endpreis korrekt berechnet wird.
	 */
	@Test
	...
	/**
	 * Testet, ob der Einkauf korrekt storniert wird.
	 */
	@Test
